...
<!-- WHY: template for training repository docs/index.md. -->
...
<!-- OBS: mkdocstrings directives below fail `--strict` if module paths change. -->
<!-- OBS: Update module names if src/toy_gpt_train/ files are renamed. -->
